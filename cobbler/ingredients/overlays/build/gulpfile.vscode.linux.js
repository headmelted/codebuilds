...
function getRpmPackageArch(arch) {
	return { x64: 'x86_64', ia32: 'i386', armhf: 'armhf', arm64: 'aarch64' }[arch];
}
...
gulp.task('clean-vscode-linux-arm64-rpm', util.rimraf('.build/linux/rpm/aarch64'));

gulp.task('clean-vscode-linux-ia32-snap', util.rimraf('.build/linux/snap/i386'));
gulp.task('clean-vscode-linux-x64-snap', util.rimraf('.build/linux/snap/x64'));
gulp.task('clean-vscode-linux-armhf-snap', util.rimraf('.build/linux/snap/armhf'));
gulp.task('clean-vscode-linux-arm64-snap', util.rimraf('.build/linux/snap/arm64'));
...
gulp.task('vscode-linux-armhf-prepare-deb', ['clean-vscode-linux-armhf-deb'], prepareDebPackage('armhf'));
...
gulp.task('vscode-linux-armhf-prepare-rpm', ['clean-vscode-linux-armhf-rpm'], prepareRpmPackage('armhf'));
...
gulp.task('vscode-linux-armhf-prepare-snap', ['clean-vscode-linux-armhf-snap'], prepareSnapPackage('armhf'));
...
gulp.task('vscode-linux-armhf-build-snap', ['vscode-linux-armhf-prepare-snap'], buildSnapPackage('armhf'));
