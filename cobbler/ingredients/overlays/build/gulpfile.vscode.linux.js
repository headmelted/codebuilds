...
function getRpmPackageArch(arch) {
	return { x64: 'x86_64', ia32: 'i386', arm: 'armhf', arm64: 'aarch64' }[arch];
}
...
gulp.task('clean-vscode-linux-arm-deb', util.rimraf('.build/linux/deb/arm'));
...
gulp.task('clean-vscode-linux-arm-rpm', util.rimraf('.build/linux/rpm/arm'));
...
gulp.task('clean-vscode-linux-arm-snap', util.rimraf('.build/linux/snap/arm'));
