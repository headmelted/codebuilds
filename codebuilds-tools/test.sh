...
if [[ ${LABEL} == "armhf_linux" ]]; then
  ...
  qemu-system-arm -nographic -serial mon:stdio -append 'console=ttyS0' -M raspi2 -dtb "./boot/bcm2709-rpi-2-b.dtb" -kernel "./boot/kernel7.img" -sd image.img -append "rw earlyprintk loglevel=8 console=ttyS0,115200 dwc_otg.lpm_enable=0 root=/dev/mmcblk0p2";
