...
if [[ "${CROSS_TOOLCHAIN}" != "true" ]]; then
  ...
  sudo apt-get install -y $build_prerequisites gcc-4.9 g++-4.9 gcc-4.9-multilib g++-4.9-multilib libc6-dev-i386;
