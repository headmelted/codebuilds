...
if [ "${CROSS_TOOLCHAIN}" != "true" ]; then
  platform_prerequisites="$build_preqrequisites gcc-4.9 g++-4.9 gcc-4.9-multilib g++-4.9-multilib libc6-dev-i386";
else
...
apt install -y $platform_prerequisites;
